...
define void @_CN7example7getLineHvEL_E(%"record.std.core:String"* noalias sret(%"record.std.core:String") %0, i8 addrspace(1)* %1) #10 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !21 {
bb2:
