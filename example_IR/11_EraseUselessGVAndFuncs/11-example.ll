...
define void @_CGFatU00000003HBDsXiiHv() #2 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !15 {
bb0:
  ret void, !dbg !17
}

define void @"_CNat5ArrayIlE6<init>Hv"(%"record.std.core:Array<T>" addrspace(1)* noalias %this, i8 addrspace(1)* %"$BP", %TypeInfo* %outerTI) #3 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !18 {
bb0:
