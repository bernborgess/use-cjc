...
@"std.core:OutOfMemoryError.ti" = external global %TypeInfo #1
...
@"std.core:Error.ti" = external global %TypeInfo #3
@"std.core:Exception.ti" = external global %TypeInfo #3

; Function Attrs: noinline
define void @_CGP7exampleiiHv() #4 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !8 !LinkageType !13 {
bb0:
  %0 = load i1, i1* @"$has_applied_pkg_init_func", align 1, !dbg !14
  br i1 %0, label %bb1, label %bb2, !dbg !14
...
bb2:                                              ; preds = %bb0
  ...
  call void @_CGP7examplefiHv(), !dbg !14
  call void @llvm.cj.pre.initialize.package(i8* null), !dbg !14
  call void @_CGFatU00000003HBDsXiiHv(), !dbg !14
  call void @_CGFatU00000004oVJx9iiHv(), !dbg !14
  call void @"_CGFatUstring$iiHv"(), !dbg !14
  call void @"_CGFatUduration$iiHv"(), !dbg !14
  call void @_CGFatU000000017ij8giiHv(), !dbg !14
  ret void, !dbg !14
}
...
; Function Attrs: noinline
define void @_CGP7exampleilHv() #4 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !15 !LinkageType !13 {
bb0:
  %0 = load i1, i1* @has_invoked_pkg_init_literal, align 1, !dbg !16
  br i1 %0, label %bb1, label %bb2, !dbg !16
...
bb2:                                              ; preds = %bb0
  ...
  call void @_CGP7exampleflHv(), !dbg !16
  ret void, !dbg !16
}
...
; Function Attrs: noinline
declare !LinkageType !13 i64 @user.main() #4 gc "cangjie"
...
is.Error:                                         ; preds = %judge.Error
  ...
  %ti = load %TypeInfo*, %TypeInfo* addrspace(1)* %21, align 8, !invariant.load !12
  %22 = bitcast %TypeInfo* %ti to i8*
  %23 = call i8* @llvm.cj.get.vtable.func(i8* %22, i64 1, i64 2, i8* bitcast (%TypeInfo* @"std.core:Error.ti" to i8*)), !IntroType !17
...
declare !LinkageType !13 void @CJ_MCC_CheckThreadLocalDataOffset()
...
; Function Attrs: noinline
define void @_CGP7exampleirHv(i8* %param) #4 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !LinkageType !13 {
entry:
...
; Function Attrs: noinline
define void @_CGP7exampleifHv() #4 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !LinkageType !13 {
entry:
...
!6 = !DIFile(filename: "0-example", directory: ".")
!7 = !{!"_CGP7exampleiiHv"}
!8 = distinct !DISubprogram(scope: !10, file: !9, type: !11, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !5, retainedNodes: !12)
...
!15 = distinct !DISubprogram(scope: !10, file: !9, type: !11, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !5, retainedNodes: !12)
