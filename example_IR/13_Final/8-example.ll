...
@StaticGenericTIs = private global [2 x %TypeInfo*] [%TypeInfo* @"RawArray<Int64>.ti", %TypeInfo* @"std.core:Array<Int64>.ti"] #9
...
define i64 @"_CN7example6<main>Hv"() #10 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !12 {
allocas:
...
; Function Attrs: noinline
declare i8 addrspace(1)* @"rt$CreateOverflowException_msg"(%"record.std.core:String"* nocapture readonly) #10 gc "cangjie"
...
attributes #9 = { "CFileStaticGenericTI" }
