...
@"$has_applied_pkg_init_func" = external global i1 #0
@has_invoked_pkg_init_literal = external global i1 #0
@Unit.Val = weak_odr global %Unit.Type undef #0
@cj.sdk.version = private global [27 x i8] c"1.1.0-alpha.20260608010034\00", align 1
@"std.core:OutOfMemoryError.ti" = external global %TypeInfo, !RelatedType !0 #1
...
@"std.core:Error.ti" = external global %TypeInfo, !RelatedType !1 #3
@"std.core:Exception.ti" = external global %TypeInfo, !RelatedType !2 #3
...
@UInt8.ti = external global %TypeInfo, !RelatedType !4 #3
...
@llvm.used = appending global [3 x i8*] [i8* bitcast (void ()* @"0_for_keeping_some_types" to i8*), i8* bitcast (void ()* @_CGP7exampleiiHv to i8*), i8* getelementptr inbounds ([27 x i8], [27 x i8]* @cj.sdk.version, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: noinline
define void @_CGP7exampleiiHv() #6 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !13 {
bb0:
  %0 = load i1, i1* @"$has_applied_pkg_init_func", align 1, !dbg !18
  br i1 %0, label %bb1, label %bb2, !dbg !18
...
bb2:                                              ; preds = %bb0
  ...
  call void @_CGP7examplefiHv(), !dbg !18
  call void @llvm.cj.pre.initialize.package(i8* null), !dbg !18
  call void @_CGFatU00000003HBDsXiiHv(), !dbg !18
  call void @_CGFatU00000004oVJx9iiHv(), !dbg !18
  call void @"_CGFatUstring$iiHv"(), !dbg !18
  call void @"_CGFatUduration$iiHv"(), !dbg !18
  call void @_CGFatU000000017ij8giiHv(), !dbg !18
  ret void, !dbg !18
}
...
; Function Attrs: noinline
declare void @_CGP7examplefiHv() #6 gc "cangjie"

; Function Attrs: nounwind
declare void @llvm.cj.pre.initialize.package(i8*) #7

; Function Attrs: noinline
declare void @_CGFatU00000003HBDsXiiHv() #6 gc "cangjie"

declare void @_CGFatU00000004oVJx9iiHv() gc "cangjie"

; Function Attrs: noinline
declare void @"_CGFatUstring$iiHv"() #6 gc "cangjie"

; Function Attrs: noinline
declare void @"_CGFatUduration$iiHv"() #6 gc "cangjie"

declare void @_CGFatU000000017ij8giiHv() gc "cangjie"

; Function Attrs: noinline
define void @_CGP7exampleilHv() #6 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !19 {
bb0:
  %0 = load i1, i1* @has_invoked_pkg_init_literal, align 1, !dbg !20
...
bb2:                                              ; preds = %bb0
  ...
  call void @_CGP7exampleflHv(), !dbg !20
  ret void, !dbg !20
}

; Function Attrs: noinline
declare void @_CGP7exampleflHv() #6 gc "cangjie"

; Function Attrs: noinline
declare i64 @user.main() #6 gc "cangjie"
...
is.Error:                                         ; preds = %judge.Error
  ...
  %ti = load %TypeInfo*, %TypeInfo* addrspace(1)* %21, align 8, !invariant.load !17
  %22 = bitcast %TypeInfo* %ti to i8*
  %23 = call i8* @llvm.cj.get.vtable.func(i8* %22, i64 1, i64 2, i8* bitcast (%TypeInfo* @"std.core:Error.ti" to i8*)), !IntroType !21
...
declare void @CJ_MCC_CheckThreadLocalDataOffset()
...
; Function Attrs: noinline
define void @_CGP7exampleirHv(i8* %param) #6 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" {
entry:
...
; Function Attrs: noinline
define void @_CGP7exampleifHv() #6 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" {
entry:
...
!0 = !{!"ObjLayout.std.core:OutOfMemoryError"}
!1 = !{!"ObjLayout.std.core:Error"}
!2 = !{!"ObjLayout.std.core:Exception"}
!3 = !{!"ArrayLayout.UInt8"}
!4 = !{!"UInt8.Type"}
!5 = !{i32 2, !"CJBC", i32 1}
...
!10 = !DIFile(filename: "0-example", directory: ".")
!11 = !{!"_CGP7exampleiiHv"}
!12 = !{i32 1, !"", !"example", !"example", !"example_example_0", !"example_example_1"}
!13 = distinct !DISubprogram(scope: !15, file: !14, type: !16, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !9, retainedNodes: !17)
!14 = !DIFile(filename: "", directory: "")
!15 = !DINamespace(name: "example", scope: null)
!16 = !DISubroutineType(types: !17)
!17 = !{}
!18 = !DILocation(line: 0, scope: !13, isImplicitCode: true)
!19 = distinct !DISubprogram(scope: !15, file: !14, type: !16, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !9, retainedNodes: !17)
!20 = !DILocation(line: 0, scope: !19, isImplicitCode: true)
!21 = !{!"std.core:Error"}
