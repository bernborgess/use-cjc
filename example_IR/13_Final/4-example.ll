...
define i1 @_CNat5RangeIlE7isEmptyHv(%"record.std.core:Range<Int64>"* noalias nocapture readonly %this, %TypeInfo* %outerTI) gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !7 {
allocas:
  %0 = alloca i1, align 1
  br label %bb0
