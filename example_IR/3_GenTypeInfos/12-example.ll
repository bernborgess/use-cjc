...
bb0:                                              ; preds = %allocas
  ...
  store i8 addrspace(1)* %9, i8 addrspace(1)** %2, align 8, !dbg !19
  %10 = call i8 addrspace(1)* @llvm.cj.alloca.generic(i8* bitcast (%TypeInfo* @"std.core:Option<std.core:String>.ti" to i8*), i32 24)
  %11 = bitcast i8 addrspace(1)* %10 to i8* addrspace(1)*, !dbg !19
  %ti.payload1 = getelementptr i8*, i8* addrspace(1)* %11, i32 1, !dbg !19
  %12 = bitcast i8* addrspace(1)* %ti.payload1 to %"enum.std.core:Option<std.core:String>" addrspace(1)*, !dbg !19
  %13 = bitcast %"enum.std.core:Option<std.core:String>" addrspace(1)* %12 to i8 addrspace(1)*, !dbg !19
  %14 = bitcast %"enum.std.core:Option<std.core:String>"* %1 to i8*, !dbg !19
  call void @llvm.cj.gcwrite.struct.p0i8.i64(i8 addrspace(1)* %10, i8 addrspace(1)* %13, i8* %14, i64 24), !dbg !19, !AggType !4
  call void @_CNat6OptionIG_E12getOrDefaultHF0G_E(i8 addrspace(1)** noalias sret(i8 addrspace(1)*) %2, i8 addrspace(1)* %10, i8 addrspace(1)* %4, %TypeInfo* @"std.core:Option<std.core:String>.ti"), !dbg !19
  %15 = load i8 addrspace(1)*, i8 addrspace(1)** %2, align 8, !dbg !19
  %16 = bitcast i8 addrspace(1)* %15 to i8* addrspace(1)*, !dbg !19
  %ti.payload2 = getelementptr i8*, i8* addrspace(1)* %16, i32 1, !dbg !19
  %17 = bitcast i8* addrspace(1)* %ti.payload2 to %"record.std.core:String" addrspace(1)*, !dbg !19
  %18 = bitcast %"record.std.core:String"* %3 to i8*, !dbg !19
  %19 = bitcast %"record.std.core:String" addrspace(1)* %17 to i8 addrspace(1)*, !dbg !19
  call void @llvm.cj.gcread.struct.i64(i8* %18, i8 addrspace(1)* %15, i8 addrspace(1)* %19, i64 16), !dbg !19, !AggType !3
