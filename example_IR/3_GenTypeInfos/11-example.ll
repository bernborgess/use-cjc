...
define void @_CGFatU000000017ij8giiHv() gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !9 !LinkageType !0 {
bb0:
  ret void, !dbg !14
}
...
define void @_CGFatU00000003HBDsXiiHv() #3 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !15 !LinkageType !0 {
bb0:
  ret void, !dbg !17
}

define void @"_CNat5ArrayIlE6<init>Hv"(%"record.std.core:Array<T>" addrspace(1)* noalias %this, i8 addrspace(1)* %"$BP", %TypeInfo* %outerTI) #4 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !18 !LinkageType !0 {
bb0:
...
!15 = distinct !DISubprogram(scope: !11, file: !16, type: !12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !13)
!16 = !DIFile(filename: "string_common.cj", directory: "std.core")
!17 = !DILocation(line: 0, scope: !15, isImplicitCode: true)
!18 = distinct !DISubprogram(scope: !11, file: !19, line: 28, type: !12, scopeLine: 28, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !13)
