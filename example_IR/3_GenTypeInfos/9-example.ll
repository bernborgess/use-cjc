...
bb0:                                              ; preds = %allocas
  ...
  %8 = call i1 @_CPIat6String5splitHRNatY0_EbE11removeEmptyHY3_(%"record.std.core:String"* %1, %"record.std.core:String"* @"$const_cjstring.fzBUmkrQ1TP", %TypeInfo* @"std.core:String.ti"), !dbg !23
  call void @_CNat6String5splitHRNatY0_Eb(%"record.std.core:Array<T>"* noalias sret(%"record.std.core:Array<T>") %2, %"record.std.core:String"* %1, %"record.std.core:String"* @"$const_cjstring.fzBUmkrQ1TP", i1 %8, %TypeInfo* @"std.core:String.ti"), !dbg !23
