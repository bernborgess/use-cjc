...
bb0:                                              ; preds = %allocas
  ...
  %3 = call noalias i8 addrspace(1)* @llvm.cj.malloc.object(i8* bitcast (%TypeInfo* @"std.core:String.ti" to i8*), i32 16), !dbg !14
  %4 = bitcast i8 addrspace(1)* %3 to i8* addrspace(1)*, !dbg !14
  ...
  %6 = bitcast %"record.std.core:String" addrspace(1)* %5 to i8 addrspace(1)*, !dbg !14
  %7 = bitcast %"record.std.core:String"* %2 to i8*, !dbg !14
  call void @llvm.cj.gcwrite.struct.p0i8.i64(i8 addrspace(1)* %3, i8 addrspace(1)* %6, i8* %7, i64 16), !dbg !14, !AggType !2
