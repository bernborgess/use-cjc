...
@StaticGenericTIs = private global [1 x %TypeInfo*] [%TypeInfo* @"RawArray<std.core:String>.ti"] #2

; Function Attrs: noinline
define void @_CGP7examplefiHv() #3 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !9 {
bb0:
...
define void @"_CNat5ArrayIRNat6StringEE6<init>Hv"(%"record.std.core:Array<T>" addrspace(1)* noalias %this, i8 addrspace(1)* %"$BP", %TypeInfo* %outerTI) #4 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !15 {
bb0:
