...
@"example:$ClN7example7getLineHvEL_E$0.ti" = external global %TypeInfo #0
...
define void @_CNat5ArrayIRNat6StringEE9normalizeHRNat5RangeIlE(%"Tuple<Int64,Int64>"* noalias sret(%"Tuple<Int64,Int64>") %0, %"record.std.core:Array<T>"* noalias nocapture readonly %this, %"record.std.core:Range<Int64>"* noalias nocapture readonly %range, %TypeInfo* %outerTI) gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !7 !LinkageType !0 {
allocas:
...
!6 = !DIFile(filename: "2-example", directory: ".")
