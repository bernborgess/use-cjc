...
define void @_CGFatU000000017ij8giiHv() gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !9 !LinkageType !14 {
bb0:
  ret void, !dbg !15
}
...
define void @_CGFatU00000003HBDsXiiHv() #2 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !16 !LinkageType !14 {
bb0:
  ret void, !dbg !18
}

define void @"_CNat5ArrayIlE6<init>Hv"(%"record.std.core:Array<T>" addrspace(1)* noalias %this, i8 addrspace(1)* %"$BP", %TypeInfo* %outerTI) #3 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !19 !LinkageType !14 {
bb0:
...
!13 = !{}
!14 = !{!"InternalLinkage"}
!15 = !DILocation(line: 0, scope: !9, isImplicitCode: true)
!16 = distinct !DISubprogram(scope: !11, file: !17, type: !12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, retainedNodes: !13)
!17 = !DIFile(filename: "string_common.cj", directory: "std.core")
!18 = !DILocation(line: 0, scope: !16, isImplicitCode: true)
!19 = distinct !DISubprogram(scope: !11, file: !20, line: 28, type: !12, scopeLine: 28, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, retainedNodes: !13)
