...
define i64 @"_CN7example6<main>Hv"() #9 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !12 !LinkageType !17 {
allocas:
...
bb0:                                              ; preds = %allocas
  ...
  call void @_CN7example7getListHv(%"record.std.core:Array<T>"* noalias sret(%"record.std.core:Array<T>") %list), !dbg !18
  store i8 addrspace(1)* null, i8 addrspace(1)** %1, align 8, !dbg !19
  %6 = call i8 addrspace(1)* @llvm.cj.alloca.generic(i8* bitcast (%TypeInfo* @Int64.ti to i8*), i32 8)
  store i8 addrspace(1)* %6, i8 addrspace(1)** %1, align 8, !dbg !19
  call void @_CNat5ArrayIG_EixHl(i8 addrspace(1)** noalias sret(i8 addrspace(1)*) %1, %"record.std.core:Array<T>"* %list, i64 0, %TypeInfo* @"std.core:Array<Int64>.ti"), !dbg !19
  %7 = load i8 addrspace(1)*, i8 addrspace(1)** %1, align 8, !dbg !19
  %8 = bitcast i8 addrspace(1)* %7 to i8* addrspace(1)*, !dbg !19
  %ti.payload = getelementptr i8*, i8* addrspace(1)* %8, i32 1, !dbg !19
  %9 = bitcast i8* addrspace(1)* %ti.payload to i64 addrspace(1)*, !dbg !19
  %10 = load i64, i64 addrspace(1)* %9, align 8, !dbg !19
  ...
  store i8 addrspace(1)* %11, i8 addrspace(1)** %2, align 8, !dbg !20
  call void @_CNat5ArrayIG_EixHl(i8 addrspace(1)** noalias sret(i8 addrspace(1)*) %2, %"record.std.core:Array<T>"* %list, i64 1, %TypeInfo* @"std.core:Array<Int64>.ti"), !dbg !20
  %12 = load i8 addrspace(1)*, i8 addrspace(1)** %2, align 8, !dbg !20
  %13 = bitcast i8 addrspace(1)* %12 to i8* addrspace(1)*, !dbg !20
  %ti.payload1 = getelementptr i8*, i8* addrspace(1)* %13, i32 1, !dbg !20
  %14 = bitcast i8* addrspace(1)* %ti.payload1 to i64 addrspace(1)*, !dbg !20
  %15 = load i64, i64 addrspace(1)* %14, align 8, !dbg !20
  %16 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %10, i64 %15), !dbg !19
  store { i64, i1 } %16, { i64, i1 }* %val.ov, align 8, !dbg !19
  %17 = getelementptr inbounds { i64, i1 }, { i64, i1 }* %val.ov, i32 0, i32 1, !dbg !19
  %18 = load i1, i1* %17, align 1, !dbg !19
  %19 = call i1 @llvm.expect.i1(i1 %18, i1 false), !dbg !19
  br i1 %19, label %overflow, label %normal, !dbg !19

normal:                                           ; preds = %bb0
  %20 = getelementptr inbounds { i64, i1 }, { i64, i1 }* %val.ov, i32 0, i32 0, !dbg !19
  %21 = load i64, i64* %20, align 8, !dbg !19
  store i64 %21, i64* %3, align 8, !dbg !19
  br label %end, !dbg !19

overflow:                                         ; preds = %bb0
  %22 = call i8 addrspace(1)* @"rt$CreateOverflowException_msg"(%"record.std.core:String"* @"$const_cjstring.ciQh56PO1Hn"), !dbg !19
  call void @llvm.cj.throw.exception(i8 addrspace(1)* %22), !dbg !19
  unreachable, !dbg !19

end:                                              ; preds = %normal
  %c = load i64, i64* %3, align 8, !dbg !19
  call void @_CNat7printlnHl(%Unit.Type* noalias sret(%Unit.Type) %4, i64 %c), !dbg !21
  store i64 0, i64* %0, align 8, !dbg !22
  %23 = load i64, i64* %0, align 8, !dbg !22
  ret i64 %23, !dbg !22
}
...
declare !LinkageType !17 void @_CN7example7getListHv(%"record.std.core:Array<T>"* noalias sret(%"record.std.core:Array<T>")) gc "cangjie"
...
!16 = !{}
!17 = !{!"ExternalLinkage"}
!18 = !DILocation(line: 16, column: 16, scope: !12)
!19 = !DILocation(line: 17, column: 13, scope: !12)
!20 = !DILocation(line: 17, column: 23, scope: !12)
!21 = !DILocation(line: 18, column: 5, scope: !12)
!22 = !DILocation(line: 19, column: 5, scope: !12)
