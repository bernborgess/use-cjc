...
define void @_CGFatU00000004oVJx9iiHv() gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !14 !LinkageType !19 {
bb0:
  ret void, !dbg !20
}
...
define void @_CN7example7getListHv(%"record.std.core:Array<T>"* noalias sret(%"record.std.core:Array<T>") %0) gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !21 !LinkageType !23 {
allocas:
...
bb0:                                              ; preds = %allocas
  %4 = call noalias i8 addrspace(1)* @llvm.cj.malloc.object(i8* bitcast (%TypeInfo* @"example:$ClN7example7getListHvEL_E$0.ti" to i8*), i32 16), !dbg !24
  %5 = bitcast i8 addrspace(1)* %4 to i8* addrspace(1)*, !dbg !24
  %ti.payload = getelementptr i8*, i8* addrspace(1)* %5, i32 1, !dbg !24
  %6 = getelementptr inbounds i8*, i8* addrspace(1)* %ti.payload, i32 0, !dbg !24
  store i8* bitcast (void (i8 addrspace(1)**, i8 addrspace(1)*, i8 addrspace(1)*, %TypeInfo*)* @"_CCN7example7getListHvEL_E$g" to i8*), i8* addrspace(1)* %6, align 8, !dbg !24
  %7 = getelementptr inbounds i8*, i8* addrspace(1)* %ti.payload, i32 1, !dbg !24
  store i8* bitcast (i64 (i8 addrspace(1)*, %"record.std.core:String"*, %TypeInfo*)* @"_CCN7example7getListHvEL_E$i" to i8*), i8* addrspace(1)* %7, align 8, !dbg !24
  %8 = bitcast %"record.std.core:String"* %1 to i8*
  call void @llvm.cj.memset.p0i8(i8* align 8 %8, i8 0, i64 16, i1 false)
  call void @_CN7example7getLineHv(%"record.std.core:String"* noalias sret(%"record.std.core:String") %1), !dbg !25
  %9 = call i1 @_CPIat6String5splitHRNatY0_EbE11removeEmptyHY3_(%"record.std.core:String"* %1, %"record.std.core:String"* @"$const_cjstring.fzBUmkrQ1TP", %TypeInfo* @"std.core:String.ti"), !dbg !25
  %10 = bitcast %"record.std.core:Array<T>"* %2 to i8*
  call void @llvm.cj.memset.p0i8(i8* align 8 %10, i8 0, i64 24, i1 false)
  call void @_CNat6String5splitHRNatY0_Eb(%"record.std.core:Array<T>"* noalias sret(%"record.std.core:Array<T>") %2, %"record.std.core:String"* %1, %"record.std.core:String"* @"$const_cjstring.fzBUmkrQ1TP", i1 %9, %TypeInfo* @"std.core:String.ti"), !dbg !25
  %11 = bitcast %"record.std.core:Array<T>"* %3 to i8*
  call void @llvm.cj.memset.p0i8(i8* align 8 %11, i8 0, i64 24, i1 false)
  call void @_CNat5ArrayIG_E3mapIG0_HF0G0_G_E(%"record.std.core:Array<T>"* noalias sret(%"record.std.core:Array<T>") %3, %"record.std.core:Array<T>"* %2, i8 addrspace(1)* %4, %TypeInfo* @Int64.ti, %TypeInfo* @"std.core:Array<std.core:String>.ti"), !dbg !25
...
declare !LinkageType !19 void @"_CCN7example7getListHvEL_E$g"(i8 addrspace(1)** noalias sret(i8 addrspace(1)*), i8 addrspace(1)*, i8 addrspace(1)*, %TypeInfo*) gc "cangjie"

declare !LinkageType !19 i64 @"_CCN7example7getListHvEL_E$i"(i8 addrspace(1)*, %"record.std.core:String"* nocapture readonly, %TypeInfo*) gc "cangjie"

declare !LinkageType !23 void @_CN7example7getLineHv(%"record.std.core:String"* noalias sret(%"record.std.core:String")) gc "cangjie"
...
!21 = distinct !DISubprogram(scope: !16, file: !22, line: 10, type: !17, scopeLine: 10, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !11, retainedNodes: !18)
!22 = !DIFile(filename: "example.cj", directory: "/home/bernborgess/Documents/use-cjc")
!23 = !{!"ExternalLinkage"}
!24 = !DILocation(line: 0, scope: !21, isImplicitCode: true)
