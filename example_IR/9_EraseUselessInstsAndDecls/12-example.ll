...
define void @_CN7example7getLineHv(%"record.std.core:String"* noalias sret(%"record.std.core:String") %0) gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !14 !LinkageType !19 {
allocas:
...
bb0:                                              ; preds = %allocas
  %4 = call noalias i8 addrspace(1)* @llvm.cj.malloc.object(i8* bitcast (%TypeInfo* @"example:$ClN7example7getLineHvEL_E$0.ti" to i8*), i32 16), !dbg !20
  %5 = bitcast i8 addrspace(1)* %4 to i8* addrspace(1)*, !dbg !20
  %ti.payload = getelementptr i8*, i8* addrspace(1)* %5, i32 1, !dbg !20
  %6 = getelementptr inbounds i8*, i8* addrspace(1)* %ti.payload, i32 0, !dbg !20
  store i8* bitcast (void (i8 addrspace(1)**, i8 addrspace(1)*, %TypeInfo*)* @"_CCN7example7getLineHvEL_E$g" to i8*), i8* addrspace(1)* %6, align 8, !dbg !20
  %7 = getelementptr inbounds i8*, i8* addrspace(1)* %ti.payload, i32 1, !dbg !20
  store i8* bitcast (void (%"record.std.core:String"*, i8 addrspace(1)*, %TypeInfo*)* @"_CCN7example7getLineHvEL_E$i" to i8*), i8* addrspace(1)* %7, align 8, !dbg !20
  %8 = call i8 addrspace(1)* @_CNay8getStdInHv(), !dbg !21
  %9 = bitcast %"enum.std.core:Option<std.core:String>"* %1 to i8*
  call void @llvm.cj.memset.p0i8(i8* align 8 %9, i8 0, i64 24, i1 false)
  call void @_CNay13ConsoleReader6readlnHv(%"enum.std.core:Option<std.core:String>"* noalias sret(%"enum.std.core:Option<std.core:String>") %1, i8 addrspace(1)* %8, %TypeInfo* @"std.env:ConsoleReader.ti"), !dbg !21
  ...
  store i8 addrspace(1)* %10, i8 addrspace(1)** %2, align 8, !dbg !21
  %11 = call i8 addrspace(1)* @llvm.cj.alloca.generic(i8* bitcast (%TypeInfo* @"std.core:Option<std.core:String>.ti" to i8*), i32 24)
  %12 = bitcast i8 addrspace(1)* %11 to i8* addrspace(1)*, !dbg !21
  %ti.payload1 = getelementptr i8*, i8* addrspace(1)* %12, i32 1, !dbg !21
  %13 = bitcast i8* addrspace(1)* %ti.payload1 to %"enum.std.core:Option<std.core:String>" addrspace(1)*, !dbg !21
  %14 = bitcast %"enum.std.core:Option<std.core:String>" addrspace(1)* %13 to i8 addrspace(1)*, !dbg !21
  %15 = bitcast %"enum.std.core:Option<std.core:String>"* %1 to i8*, !dbg !21
  call void @llvm.cj.gcwrite.struct.p0i8.i64(i8 addrspace(1)* %11, i8 addrspace(1)* %14, i8* %15, i64 24), !dbg !21, !AggType !3
  call void @_CNat6OptionIG_E12getOrDefaultHF0G_E(i8 addrspace(1)** noalias sret(i8 addrspace(1)*) %2, i8 addrspace(1)* %11, i8 addrspace(1)* %4, %TypeInfo* @"std.core:Option<std.core:String>.ti"), !dbg !21
  %16 = load i8 addrspace(1)*, i8 addrspace(1)** %2, align 8, !dbg !21
  %17 = bitcast i8 addrspace(1)* %16 to i8* addrspace(1)*, !dbg !21
  %ti.payload2 = getelementptr i8*, i8* addrspace(1)* %17, i32 1, !dbg !21
  %18 = bitcast i8* addrspace(1)* %ti.payload2 to %"record.std.core:String" addrspace(1)*, !dbg !21
  %19 = bitcast %"record.std.core:String"* %3 to i8*
  call void @llvm.cj.memset.p0i8(i8* align 8 %19, i8 0, i64 16, i1 false)
  %20 = bitcast %"record.std.core:String"* %3 to i8*, !dbg !21
  %21 = bitcast %"record.std.core:String" addrspace(1)* %18 to i8 addrspace(1)*, !dbg !21
  call void @llvm.cj.gcread.struct.i64(i8* %20, i8 addrspace(1)* %16, i8 addrspace(1)* %21, i64 16), !dbg !21, !AggType !2
...
declare !LinkageType !22 void @"_CCN7example7getLineHvEL_E$g"(i8 addrspace(1)** noalias sret(i8 addrspace(1)*), i8 addrspace(1)*, %TypeInfo*) gc "cangjie"

declare !LinkageType !22 void @"_CCN7example7getLineHvEL_E$i"(%"record.std.core:String"* noalias sret(%"record.std.core:String"), i8 addrspace(1)*, %TypeInfo*) gc "cangjie"
...
define void @_CN7example7getLineHvEL_E(%"record.std.core:String"* noalias sret(%"record.std.core:String") %0, i8 addrspace(1)* %1) #10 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !23 !LinkageType !22 {
bb2:
...
!22 = !{!"InternalLinkage"}
!23 = distinct !DISubprogram(scope: !16, file: !15, line: 7, type: !17, scopeLine: 7, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !11, retainedNodes: !18)
