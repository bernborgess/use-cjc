...
define i1 @_CNat5ArrayIlE7isLegalHll(%"record.std.core:Array<T>"* noalias nocapture readonly %this, i64 %start_, i64 %end_, %TypeInfo* %outerTI) gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !7 !LinkageType !12 {
allocas:
  %0 = alloca i1, align 1
  %1 = alloca i1, align 1
  %2 = alloca i1, align 1
...
!11 = !{}
!12 = !{!"InternalLinkage"}
!13 = !DILocation(line: 224, column: 9, scope: !7)
!14 = !DILocation(line: 224, column: 24, scope: !7)
!15 = !DILocation(line: 224, column: 50, scope: !7)
!16 = !DILocation(line: 224, column: 42, scope: !7)
