...
define void @_CGP7examplefiHv() #2 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !9 !LinkageType !14 {
bb0:
...
define void @"_CNat5ArrayIRNat6StringEE6<init>Hv"(%"record.std.core:Array<T>" addrspace(1)* noalias %this, i8 addrspace(1)* %"$BP", %TypeInfo* %outerTI) #3 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !16 !LinkageType !14 {
bb0:
...
!16 = distinct !DISubprogram(scope: !11, file: !17, line: 28, type: !12, scopeLine: 28, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, retainedNodes: !13)
