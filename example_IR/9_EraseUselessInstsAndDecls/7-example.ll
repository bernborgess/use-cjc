...
define void @"_CNat5RangeIlE6<init>Hlllbbb"(%"record.std.core:Range<Int64>" addrspace(1)* noalias %this, i8 addrspace(1)* %"$BP", i64 %start, i64 %end, i64 %step, i1 %hasStart, i1 %hasEnd, i1 %isClosed, %TypeInfo* %outerTI) #5 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !10 !LinkageType !15 {
bb0:
...
!14 = !{}
!15 = !{!"InternalLinkage"}
!16 = !DILocation(line: 25, column: 13, scope: !10)
!17 = !DILocation(line: 25, column: 9, scope: !10)
!18 = !DILocation(line: 26, column: 19, scope: !10)
!19 = !DILocation(line: 26, column: 13, scope: !10)
!20 = !DILocation(line: 28, column: 9, scope: !10)
!21 = !DILocation(line: 29, column: 9, scope: !10)
!22 = !DILocation(line: 30, column: 9, scope: !10)
!23 = !DILocation(line: 31, column: 9, scope: !10)
!24 = !DILocation(line: 32, column: 9, scope: !10)
!25 = !DILocation(line: 33, column: 9, scope: !10)
!26 = !DILocation(line: 34, column: 5, scope: !10)
