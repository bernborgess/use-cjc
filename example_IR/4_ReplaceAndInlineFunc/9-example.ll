...
define void @_CGFatU00000004oVJx9iiHv() gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !13 !LinkageType !1 {
bb0:
  ret void, !dbg !18
}
...
define void @_CN7example7getListHv(%"record.std.core:Array<T>"* noalias sret(%"record.std.core:Array<T>") %0) gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !19 !LinkageType !21 {
allocas:
...
declare !LinkageType !21 void @_CN7example7getLineHv(%"record.std.core:String"* noalias sret(%"record.std.core:String")) gc "cangjie"
...
!13 = distinct !DISubprogram(scope: !15, file: !14, type: !16, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !11, retainedNodes: !17)
!14 = !DIFile(filename: "string_builder.cj", directory: "std.core")
!15 = !DINamespace(name: "example", scope: null)
!16 = !DISubroutineType(types: !17)
!17 = !{}
!18 = !DILocation(line: 0, scope: !13, isImplicitCode: true)
!19 = distinct !DISubprogram(scope: !15, file: !20, line: 10, type: !16, scopeLine: 10, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !11, retainedNodes: !17)
!20 = !DIFile(filename: "example.cj", directory: "/home/bernborgess/Documents/use-cjc")
!21 = !{!"ExternalLinkage"}
!22 = !DILocation(line: 0, scope: !19, isImplicitCode: true)
!23 = !DILocation(line: 11, column: 5, scope: !19)
