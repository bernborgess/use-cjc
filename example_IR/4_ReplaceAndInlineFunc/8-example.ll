...
bb0:                                              ; preds = %allocas
  ...
  store i8 addrspace(1)* %6, i8 addrspace(1)** %1, align 8, !dbg !17
  ...
  %7 = load i8 addrspace(1)*, i8 addrspace(1)** %1, align 8, !dbg !17
  %8 = bitcast i8 addrspace(1)* %7 to i8* addrspace(1)*, !dbg !17
  %ti.payload = getelementptr i8*, i8* addrspace(1)* %8, i32 1, !dbg !17
  %9 = bitcast i8* addrspace(1)* %ti.payload to i64 addrspace(1)*, !dbg !17
  %10 = load i64, i64 addrspace(1)* %9, align 8, !dbg !17
  ...
  store i8 addrspace(1)* %11, i8 addrspace(1)** %2, align 8, !dbg !18
  ...
  %12 = load i8 addrspace(1)*, i8 addrspace(1)** %2, align 8, !dbg !18
  %13 = bitcast i8 addrspace(1)* %12 to i8* addrspace(1)*, !dbg !18
  %ti.payload1 = getelementptr i8*, i8* addrspace(1)* %13, i32 1, !dbg !18
  %14 = bitcast i8* addrspace(1)* %ti.payload1 to i64 addrspace(1)*, !dbg !18
  %15 = load i64, i64 addrspace(1)* %14, align 8, !dbg !18
  %16 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %10, i64 %15), !dbg !17
  store { i64, i1 } %16, { i64, i1 }* %val.ov, align 8, !dbg !17
  %17 = getelementptr inbounds { i64, i1 }, { i64, i1 }* %val.ov, i32 0, i32 1, !dbg !17
  %18 = load i1, i1* %17, align 1, !dbg !17
  %19 = call i1 @llvm.expect.i1(i1 %18, i1 false), !dbg !17
  br i1 %19, label %overflow, label %normal, !dbg !17

normal:                                           ; preds = %bb0
  %20 = getelementptr inbounds { i64, i1 }, { i64, i1 }* %val.ov, i32 0, i32 0, !dbg !17
  %21 = load i64, i64* %20, align 8, !dbg !17
  store i64 %21, i64* %3, align 8, !dbg !17
  br label %end, !dbg !17

overflow:                                         ; preds = %bb0
  %22 = call i8 addrspace(1)* @"rt$CreateOverflowException_msg"(%"record.std.core:String"* @"$const_cjstring.ciQh56PO1Hn"), !dbg !17
  call void @llvm.cj.throw.exception(i8 addrspace(1)* %22), !dbg !17
  unreachable, !dbg !17
  ...
  %23 = load i64, i64* %0, align 8, !dbg !20
  ret i64 %23, !dbg !20
}
