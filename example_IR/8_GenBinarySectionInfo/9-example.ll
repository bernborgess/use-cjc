...
@"$const_cjstring.fzBUmkrQ1TP" = private constant %"record.std.core:String" { i8 addrspace(1)* addrspacecast (i8* bitcast ({ i8*, i64, [1 x i8] }* @"$const_cjstring_data.fzBUmkrQ1TP" to i8*) to i8 addrspace(1)*), i32 0, i32 1 } #2
...
@UInt8.ti = external global %TypeInfo, !RelatedType !8 #0
@"RawArray<UInt8>.name" = private unnamed_addr constant [16 x i8] c"RawArray<UInt8>\00", align 1 #3
@"$const_cjstring_data.fzBUmkrQ1TP" = private constant { i8*, i64, [1 x i8] } { i8* bitcast (%TypeInfo* @"RawArray<UInt8>.ti" to i8*), i64 1, [1 x i8] c" " } #8

define void @_CGFatU00000004oVJx9iiHv() gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !16 !LinkageType !1 {
bb0:
  ret void, !dbg !21
}
...
define void @_CN7example7getListHv(%"record.std.core:Array<T>"* noalias sret(%"record.std.core:Array<T>") %0) gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !22 !LinkageType !24 {
allocas:
...
bb0:                                              ; preds = %allocas
  %4 = call noalias i8 addrspace(1)* @llvm.cj.malloc.object(i8* bitcast (%TypeInfo* @"example:$ClN7example7getListHvEL_E$0.ti" to i8*), i32 16), !dbg !25
  %5 = bitcast i8 addrspace(1)* %4 to i8* addrspace(1)*, !dbg !25
  %ti.payload = getelementptr i8*, i8* addrspace(1)* %5, i32 1, !dbg !25
  %6 = getelementptr inbounds i8*, i8* addrspace(1)* %ti.payload, i32 0, !dbg !25
  store i8* bitcast (void (i8 addrspace(1)**, i8 addrspace(1)*, i8 addrspace(1)*, %TypeInfo*)* @"_CCN7example7getListHvEL_E$g" to i8*), i8* addrspace(1)* %6, align 8, !dbg !25
  %7 = getelementptr inbounds i8*, i8* addrspace(1)* %ti.payload, i32 1, !dbg !25
  store i8* bitcast (i64 (i8 addrspace(1)*, %"record.std.core:String"*, %TypeInfo*)* @"_CCN7example7getListHvEL_E$i" to i8*), i8* addrspace(1)* %7, align 8, !dbg !25
  %8 = bitcast %"record.std.core:String"* %1 to i8*
  call void @llvm.cj.memset.p0i8(i8* align 8 %8, i8 0, i64 16, i1 false)
  call void @_CN7example7getLineHv(%"record.std.core:String"* noalias sret(%"record.std.core:String") %1), !dbg !26
  %9 = call i1 @_CPIat6String5splitHRNatY0_EbE11removeEmptyHY3_(%"record.std.core:String"* %1, %"record.std.core:String"* @"$const_cjstring.fzBUmkrQ1TP", %TypeInfo* @"std.core:String.ti"), !dbg !26
  %10 = bitcast %"record.std.core:Array<T>"* %2 to i8*
  call void @llvm.cj.memset.p0i8(i8* align 8 %10, i8 0, i64 24, i1 false)
  call void @_CNat6String5splitHRNatY0_Eb(%"record.std.core:Array<T>"* noalias sret(%"record.std.core:Array<T>") %2, %"record.std.core:String"* %1, %"record.std.core:String"* @"$const_cjstring.fzBUmkrQ1TP", i1 %9, %TypeInfo* @"std.core:String.ti"), !dbg !26
  %11 = bitcast %"record.std.core:Array<T>"* %3 to i8*
  call void @llvm.cj.memset.p0i8(i8* align 8 %11, i8 0, i64 24, i1 false)
  call void @_CNat5ArrayIG_E3mapIG0_HF0G0_G_E(%"record.std.core:Array<T>"* noalias sret(%"record.std.core:Array<T>") %3, %"record.std.core:Array<T>"* %2, i8 addrspace(1)* %4, %TypeInfo* @Int64.ti, %TypeInfo* @"std.core:Array<std.core:String>.ti"), !dbg !26
...
declare !LinkageType !24 void @_CN7example7getLineHv(%"record.std.core:String"* noalias sret(%"record.std.core:String")) gc "cangjie"
...
declare void @llvm.cj.memset.p0i8(i8* nocapture writeonly, i8, i64, i1) #11

; Function Attrs: noinline optnone
define private void @"0_for_keeping_some_types"() #12 {
entry.unreachable:
...
attributes #11 = { argmemonly nounwind writeonly }
...
!8 = !{!"UInt8.Type"}
!9 = !{i32 2, !"CJBC", i32 1}
!10 = !{i32 2, !"Cangjie_OPT", i32 0}
!11 = !{i32 2, !"Debug Info Version", i32 3}
!12 = !{i32 2, !"Dwarf Version", i32 4}
!13 = distinct !DICompileUnit(language: DW_LANG_C_plus_plus_14, file: !14, producer: "Cangjie Compiler", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug)
!14 = !DIFile(filename: "9-example", directory: ".")
!15 = !{i32 1, !"", !"example", !"example", !"example_example_9", !"example_example_10"}
!16 = distinct !DISubprogram(scope: !18, file: !17, type: !19, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !13, retainedNodes: !20)
!17 = !DIFile(filename: "string_builder.cj", directory: "std.core")
!18 = !DINamespace(name: "example", scope: null)
!19 = !DISubroutineType(types: !20)
!20 = !{}
!21 = !DILocation(line: 0, scope: !16, isImplicitCode: true)
!22 = distinct !DISubprogram(scope: !18, file: !23, line: 10, type: !19, scopeLine: 10, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !13, retainedNodes: !20)
!23 = !DIFile(filename: "example.cj", directory: "/home/bernborgess/Documents/use-cjc")
!24 = !{!"ExternalLinkage"}
!25 = !DILocation(line: 0, scope: !22, isImplicitCode: true)
