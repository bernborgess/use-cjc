...
@"$const_cjstring.5k+AV0uhyFK" = private constant %"record.std.core:String" { i8 addrspace(1)* addrspacecast (i8* bitcast ({ i8*, i64, [0 x i8] }* @"$const_cjstring_data.5k+AV0uhyFK" to i8*) to i8 addrspace(1)*), i32 0, i32 0 } #3
...
@UInt8.ti = external global %TypeInfo, !RelatedType !7 #1
...
@"$const_cjstring_data.5k+AV0uhyFK" = private constant { i8*, i64, [0 x i8] } { i8* bitcast (%TypeInfo* @"RawArray<UInt8>.ti" to i8*), i64 0, [0 x i8] zeroinitializer } #8

define void @_CN7example7getLineHv(%"record.std.core:String"* noalias sret(%"record.std.core:String") %0) gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !15 !LinkageType !20 {
allocas:
...
bb0:                                              ; preds = %allocas
  %4 = call noalias i8 addrspace(1)* @llvm.cj.malloc.object(i8* bitcast (%TypeInfo* @"example:$ClN7example7getLineHvEL_E$0.ti" to i8*), i32 16), !dbg !21
  %5 = bitcast i8 addrspace(1)* %4 to i8* addrspace(1)*, !dbg !21
  %ti.payload = getelementptr i8*, i8* addrspace(1)* %5, i32 1, !dbg !21
  %6 = getelementptr inbounds i8*, i8* addrspace(1)* %ti.payload, i32 0, !dbg !21
  store i8* bitcast (void (i8 addrspace(1)**, i8 addrspace(1)*, %TypeInfo*)* @"_CCN7example7getLineHvEL_E$g" to i8*), i8* addrspace(1)* %6, align 8, !dbg !21
  %7 = getelementptr inbounds i8*, i8* addrspace(1)* %ti.payload, i32 1, !dbg !21
  store i8* bitcast (void (%"record.std.core:String"*, i8 addrspace(1)*, %TypeInfo*)* @"_CCN7example7getLineHvEL_E$i" to i8*), i8* addrspace(1)* %7, align 8, !dbg !21
  %8 = call i8 addrspace(1)* @_CNay8getStdInHv(), !dbg !22
  %9 = bitcast %"enum.std.core:Option<std.core:String>"* %1 to i8*
  call void @llvm.cj.memset.p0i8(i8* align 8 %9, i8 0, i64 24, i1 false)
  call void @_CNay13ConsoleReader6readlnHv(%"enum.std.core:Option<std.core:String>"* noalias sret(%"enum.std.core:Option<std.core:String>") %1, i8 addrspace(1)* %8, %TypeInfo* @"std.env:ConsoleReader.ti"), !dbg !22
  store i8 addrspace(1)* null, i8 addrspace(1)** %2, align 8, !dbg !22
  %10 = call i8 addrspace(1)* @llvm.cj.alloca.generic(i8* bitcast (%TypeInfo* @"std.core:String.ti" to i8*), i32 16)
  store i8 addrspace(1)* %10, i8 addrspace(1)** %2, align 8, !dbg !22
  %11 = call i8 addrspace(1)* @llvm.cj.alloca.generic(i8* bitcast (%TypeInfo* @"std.core:Option<std.core:String>.ti" to i8*), i32 24)
  %12 = bitcast i8 addrspace(1)* %11 to i8* addrspace(1)*, !dbg !22
  %ti.payload1 = getelementptr i8*, i8* addrspace(1)* %12, i32 1, !dbg !22
  %13 = bitcast i8* addrspace(1)* %ti.payload1 to %"enum.std.core:Option<std.core:String>" addrspace(1)*, !dbg !22
  %14 = bitcast %"enum.std.core:Option<std.core:String>" addrspace(1)* %13 to i8 addrspace(1)*, !dbg !22
  %15 = bitcast %"enum.std.core:Option<std.core:String>"* %1 to i8*, !dbg !22
  call void @llvm.cj.gcwrite.struct.p0i8.i64(i8 addrspace(1)* %11, i8 addrspace(1)* %14, i8* %15, i64 24), !dbg !22, !AggType !4
  call void @_CNat6OptionIG_E12getOrDefaultHF0G_E(i8 addrspace(1)** noalias sret(i8 addrspace(1)*) %2, i8 addrspace(1)* %11, i8 addrspace(1)* %4, %TypeInfo* @"std.core:Option<std.core:String>.ti"), !dbg !22
  %16 = load i8 addrspace(1)*, i8 addrspace(1)** %2, align 8, !dbg !22
  %17 = bitcast i8 addrspace(1)* %16 to i8* addrspace(1)*, !dbg !22
  %ti.payload2 = getelementptr i8*, i8* addrspace(1)* %17, i32 1, !dbg !22
  %18 = bitcast i8* addrspace(1)* %ti.payload2 to %"record.std.core:String" addrspace(1)*, !dbg !22
  %19 = bitcast %"record.std.core:String"* %3 to i8*
  call void @llvm.cj.memset.p0i8(i8* align 8 %19, i8 0, i64 16, i1 false)
  %20 = bitcast %"record.std.core:String"* %3 to i8*, !dbg !22
  %21 = bitcast %"record.std.core:String" addrspace(1)* %18 to i8 addrspace(1)*, !dbg !22
  call void @llvm.cj.gcread.struct.i64(i8* %20, i8 addrspace(1)* %16, i8 addrspace(1)* %21, i64 16), !dbg !22, !AggType !3
...
define void @_CN7example7getLineHvEL_E(%"record.std.core:String"* noalias sret(%"record.std.core:String") %0, i8 addrspace(1)* %1) #11 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !23 !LinkageType !0 {
bb2:
...
define private void @"0_for_keeping_some_types"() #14 {
entry.unreachable:
...
!7 = !{!"UInt8.Type"}
!8 = !{i32 2, !"CJBC", i32 1}
!9 = !{i32 2, !"Cangjie_OPT", i32 0}
!10 = !{i32 2, !"Debug Info Version", i32 3}
!11 = !{i32 2, !"Dwarf Version", i32 4}
!12 = distinct !DICompileUnit(language: DW_LANG_C_plus_plus_14, file: !13, producer: "Cangjie Compiler", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug)
!13 = !DIFile(filename: "12-example", directory: ".")
!14 = !{i32 1, !"", !"example", !"example", !"example_example_12", !"example_example_13"}
!15 = distinct !DISubprogram(scope: !17, file: !16, line: 6, type: !18, scopeLine: 6, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !12, retainedNodes: !19)
!16 = !DIFile(filename: "example.cj", directory: "/home/bernborgess/Documents/use-cjc")
!17 = !DINamespace(name: "example", scope: null)
!18 = !DISubroutineType(types: !19)
!19 = !{}
!20 = !{!"ExternalLinkage"}
!21 = !DILocation(line: 0, scope: !15, isImplicitCode: true)
!22 = !DILocation(line: 7, column: 5, scope: !15)
!23 = distinct !DISubprogram(scope: !17, file: !16, line: 7, type: !18, scopeLine: 7, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !12, retainedNodes: !19)
!24 = !DILocation(line: 7, column: 42, scope: !23)
