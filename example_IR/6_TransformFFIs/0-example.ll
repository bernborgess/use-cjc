...
define void @_CGP7exampleiiHv() #4 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !12 !LinkageType !17 {
bb0:
...
; Function Attrs: noinline
define void @_CGP7exampleilHv() #4 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !19 !LinkageType !17 {
bb0:
...
; Function Attrs: noinline
declare !LinkageType !17 i64 @user.main() #4 gc "cangjie"
...
is.Error:                                         ; preds = %judge.Error
  ...
  %ti = load %TypeInfo*, %TypeInfo* addrspace(1)* %21, align 8, !invariant.load !16
...
declare !LinkageType !17 void @CJ_MCC_CheckThreadLocalDataOffset()
...
; Function Attrs: noinline
define void @_CGP7exampleirHv(i8* %param) #4 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !LinkageType !17 {
entry:
...
; Function Attrs: noinline
define void @_CGP7exampleifHv() #4 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !LinkageType !17 {
entry:
...
!10 = !{!"_CGP7exampleiiHv"}
!11 = !{i32 1, !"", !"example", !"example", !"example_example_0", !"example_example_1"}
!12 = distinct !DISubprogram(scope: !14, file: !13, type: !15, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !8, retainedNodes: !16)
...
!19 = distinct !DISubprogram(scope: !14, file: !13, type: !15, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !8, retainedNodes: !16)
