...
define void @_CN7example7getLineHv(%"record.std.core:String"* noalias sret(%"record.std.core:String") %0) gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !13 !LinkageType !18 {
allocas:
...
bb0:                                              ; preds = %allocas
  ...
  call void @llvm.cj.gcwrite.struct.p0i8.i64(i8 addrspace(1)* %11, i8 addrspace(1)* %14, i8* %15, i64 24), !dbg !20, !AggType !4
  ...
  call void @llvm.cj.gcread.struct.i64(i8* %20, i8 addrspace(1)* %16, i8 addrspace(1)* %21, i64 16), !dbg !20, !AggType !3
...
define void @_CN7example7getLineHvEL_E(%"record.std.core:String"* noalias sret(%"record.std.core:String") %0, i8 addrspace(1)* %1) #10 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !21 !LinkageType !0 {
bb2:
...
!12 = !{i32 1, !"", !"example", !"example", !"example_example_12", !"example_example_13"}
!13 = distinct !DISubprogram(scope: !15, file: !14, line: 6, type: !16, scopeLine: 6, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !10, retainedNodes: !17)
!14 = !DIFile(filename: "example.cj", directory: "/home/bernborgess/Documents/use-cjc")
!15 = !DINamespace(name: "example", scope: null)
!16 = !DISubroutineType(types: !17)
!17 = !{}
!18 = !{!"ExternalLinkage"}
!19 = !DILocation(line: 0, scope: !13, isImplicitCode: true)
!20 = !DILocation(line: 7, column: 5, scope: !13)
!21 = distinct !DISubprogram(scope: !15, file: !14, line: 7, type: !16, scopeLine: 7, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !10, retainedNodes: !17)
