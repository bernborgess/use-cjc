...
define i64 @"_CN7example6<main>Hv"() #7 gc "cangjie" personality i32 (...)* @"__cj_personality_v0$" !dbg !11 !LinkageType !16 {
allocas:
...
declare !LinkageType !16 void @_CN7example7getListHv(%"record.std.core:Array<T>"* noalias sret(%"record.std.core:Array<T>")) gc "cangjie"
...
!10 = !{i32 1, !"", !"example", !"example", !"example_example_8", !"example_example_9"}
!11 = distinct !DISubprogram(scope: !13, file: !12, line: 15, type: !14, scopeLine: 15, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !8, retainedNodes: !15)
!12 = !DIFile(filename: "example.cj", directory: "/home/bernborgess/Documents/use-cjc")
!13 = !DINamespace(name: "example", scope: null)
!14 = !DISubroutineType(types: !15)
!15 = !{}
!16 = !{!"ExternalLinkage"}
!17 = !DILocation(line: 16, column: 16, scope: !11)
!18 = !DILocation(line: 17, column: 13, scope: !11)
!19 = !DILocation(line: 17, column: 23, scope: !11)
!20 = !DILocation(line: 18, column: 5, scope: !11)
!21 = !DILocation(line: 19, column: 5, scope: !11)
